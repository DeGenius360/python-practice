...
def getHandValue(cards):
	"""Returns the value of the cards. Face cards are worth 10, aces are worth 1 or 11 (this function picks the most suitable ace value)"""
	value = 0
	numberOfAces = 0
...
def getMove(playerHand, money):
	...
	while True: # Keep looping until the player enters a correct move.
		...
		# tell bacause they'll have exactly two cards:
